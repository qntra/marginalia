...
- [x] this backlog — division overview, structure, what it builds, what it refuses
...
- [x] site skeleton — `marginalia.quantara.cv/index.html`, ready for the subdomain

## doing now

- [ ] first research sprint — pick a topic the division should know about and write it up
